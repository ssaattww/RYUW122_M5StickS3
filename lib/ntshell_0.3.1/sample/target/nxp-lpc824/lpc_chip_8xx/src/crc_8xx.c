...
void Chip_CRC_Init(void) { Chip_Clock_EnablePeriphClock(SYSCTL_CLOCK_CRC); }

/* De-initialize CRC engine */
void Chip_CRC_Deinit(void) { Chip_Clock_DisablePeriphClock(SYSCTL_CLOCK_CRC); }
...
/* Convenience function for computing a standard CRC16 checksum from 16-bit data
 * block */
...
/* Convenience function for computing a standard CRC32 checksum from 32-bit data
 * block */
