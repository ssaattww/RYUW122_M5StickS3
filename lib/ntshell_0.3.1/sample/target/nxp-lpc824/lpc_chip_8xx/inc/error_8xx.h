...
{
  /**\b 0x00000000*/ LPC_OK =
      0, /**< enum value returned on Successful completion */
  ...
  /**\b 0x00000002*/ ERR_ISP_SRC_ADDR_ERROR, /*!< Source address not on word
                                                boundary */
  /**\b 0x00000003*/ ERR_ISP_DST_ADDR_ERROR, /*!< Destination address not on
                                                word or 256 byte boundary */
  /**\b 0x00000004*/ ERR_ISP_SRC_ADDR_NOT_MAPPED,
  /**\b 0x00000005*/ ERR_ISP_DST_ADDR_NOT_MAPPED,
  /**\b 0x00000006*/ ERR_ISP_COUNT_ERROR, /*!< Byte count is not multiple of 4
                                             or is not a permitted value */
  ...
  /**\b 0x0000000B*/ ERR_ISP_BUSY, /*!< Flash programming hardware interface is
                                      busy */
  ...
  /**\b 0x00060006*/ ERR_I2C_LOSS_OF_ARBRITRATION_NAK_BIT, /*!< Loss arbritation
                                                              NAK */
  ...
  /**\b 0x00080001*/ ERR_UART_RXD_BUSY =
      ERR_UART_BASE + 1,                /*!< Receive is busy */
  /**\b 0x00080002*/ ERR_UART_TXD_BUSY, /*!< Transmit is busy */
  /**\b 0x00080003*/ ERR_UART_OVERRUN_FRAME_PARITY_NOISE, /*!< Overrun, Frame,
                                                             Parity , Receive
                                                             Noise error */
