...
#define NUM_IOCON_PIO (29)
  ...
  /**
   * @brief Array of IOCON pin definitions passed to Chip_IOCON_SetPinMuxing()
   ...
   * Correct: LPC_IOCON->PIO0[IOCON_PIO0] = 0x1; // Enumeration PIO0 maps to pin
   * 0
   */
  typedef struct
...
#define PIN_I2CMODE_BITNUM (8)
   ...
   * changed.<br>
   * Example: LPC_IOCON->PIO0[IOCON_PIO0] = 0x1; // Enumeration PIO0 maps to pin
   * 0
   */
  ...
  typedef enum CHIP_PIN_SMODE
  {
    ...
    PIN_SMODE_CYC1 =
        1, /*!< Input pulses shorter than 1 filter clock cycle are rejected */
    PIN_SMODE_CYC2 =
        2, /*!< Input pulses shorter than 2 filter clock cycles are rejected */
    PIN_SMODE_CYC3 =
        3 /*!< Input pulses shorter than 3 filter clock cycles are rejected */
  } CHIP_PIN_SMODE_T;
   ...
   * @return	Nothing
   */
  STATIC INLINE void Chip_IOCON_PinMuxSet(LPC_IOCON_T *pIOCON, uint8_t pin,
                                          uint32_t modefunc)
  {
   ...
   */
  void Chip_IOCON_PinSetMode(LPC_IOCON_T *pIOCON, CHIP_PINx_T pin,
   ...
   * @note	Do not use with pins PIO10 and PIO11.
   */
  void Chip_IOCON_PinSetHysteresis(LPC_IOCON_T *pIOCON, CHIP_PINx_T pin,
                                   bool enable);
   ...
   * @note	Do not use with pins PIO10 and PIO11.
   */
  STATIC INLINE void Chip_IOCON_PinEnableHysteresis(LPC_IOCON_T *pIOCON,
                                                    CHIP_PINx_T pin)
  {
   ...
   * @note	Do not use with pins PIO10 and PIO11.
   */
  STATIC INLINE void Chip_IOCON_PinDisableHysteresis(LPC_IOCON_T *pIOCON,
                                                     CHIP_PINx_T pin)
  {
    pIOCON->PIO0[pin] &= ~PIN_HYS_MASK;
  }
   ...
   * @return	Nothing
   */
  void Chip_IOCON_PinSetInputInverted(LPC_IOCON_T *pIOCON, CHIP_PINx_T pin,
                                      bool invert);
   ...
   * @return	Nothing
   */
  STATIC INLINE void Chip_IOCON_PinEnableInputInverted(LPC_IOCON_T *pIOCON,
                                                       CHIP_PINx_T pin)
  {
   ...
   * @return	Nothing
   */
  STATIC INLINE void Chip_IOCON_PinDisableInputInverted(LPC_IOCON_T *pIOCON,
                                                        CHIP_PINx_T pin)
  {
    pIOCON->PIO0[pin] &= ~PIN_INV_MASK;
  }
   ...
   * @return	Nothing
   */
  void Chip_IOCON_PinSetOpenDrainMode(LPC_IOCON_T *pIOCON, CHIP_PINx_T pin,
                                      bool open_drain);
   ...
   * @return	Nothing
   */
  STATIC INLINE void Chip_IOCON_PinEnableOpenDrainMode(LPC_IOCON_T *pIOCON,
                                                       CHIP_PINx_T pin)
  {
   ...
   * @return	Nothing
   */
  STATIC INLINE void Chip_IOCON_PinDisableOpenDrainMode(LPC_IOCON_T *pIOCON,
                                                        CHIP_PINx_T pin)
  {
    pIOCON->PIO0[pin] &= ~PIN_OD_MASK;
  }
   ...
   * @return	Nothing
   */
  void Chip_IOCON_PinSetSampleMode(LPC_IOCON_T *pIOCON, CHIP_PINx_T pin,
   ...
   * @return	Nothing
   */
  void Chip_IOCON_PinSetClockDivisor(LPC_IOCON_T *pIOCON, CHIP_PINx_T pin,
   ...
   */
  void Chip_IOCON_PinSetI2CMode(LPC_IOCON_T *pIOCON, CHIP_PINx_T pin,
