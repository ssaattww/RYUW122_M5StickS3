...
extern "C"
{
  ...
  typedef struct
  {
    ...
    __IO uint32_t
        GPREG[4]; /*!< Offset: 0x004 General purpose Registers 0..3 (R/W) */
    __IO uint32_t
        DPDCTRL; /*!< Offset: 0x014 Deep power-down control register (R/W) */
  } LPC_PMU_T;
...
#define PMU_PCON_PM_DEEPPOWERDOWN                                              \
  (0x3)                             /*!< ARM WFI enter Deep Power-down mode */
...
#define PMU_DPDCTRL_LPOSCDPDEN                                                 \
   ...
   * @return	None
   */
  STATIC INLINE void Chip_PMU_WriteGPREG(LPC_PMU_T *pPMU, uint8_t regIndex,
                                         uint32_t value)
  {
   ...
   * definitions.
   */
  STATIC INLINE void Chip_PMU_SetPowerDownControl(LPC_PMU_T *pPMU,
                                                  uint32_t flags)
  {
   ...
   * definitions.
   */
  STATIC INLINE void Chip_PMU_ClearPowerDownControl(LPC_PMU_T *pPMU,
                                                    uint32_t flags)
  {
