 ...
 * 			@a itemSize, and @a count must be a power of 2 and must
 * at least be 2 or greater.
 * @return	Nothing
 */
 ...
 * @param	num			: Max number of items array @a data can
 * hold
 * @return	Number of items popped onto @a data,
 * 			0 on error (Buffer not initialized using
 * RingBuffer_Init() or attempted to pop when the buffer is empty)
 */
