...
extern "C"
{
  ...
  typedef struct
  {                    /* I2C0 Structure         */
    __IO uint32_t CFG; /*!< I2C Configuration Register common for Master, Slave
                          and Monitor */
    __IO uint32_t
        STAT; /*!< I2C Status Register common for Master, Slave and Monitor */
    __IO uint32_t INTENSET; /*!< I2C Interrupt Enable Set Register common for
                               Master, Slave and Monitor */
    __O uint32_t INTENCLR;  /*!< I2C Interrupt Enable Clear Register common for
                               Master, Slave and Monitor */
...
#define I2C_INTENSET_RESERVED                                                  \
  ((7 << 1) | (1 << 5) | (1 << 7) | (3 << 9) | (7 << 12) | (1 << 18) |         \
   (0xf << 20) | (0x3fu << 26))
#define I2C_INTENCLR_RESERVED                                                  \
  ((7 << 1) | (1 << 5) | (1 << 7) | (3 << 9) | (7 << 12) | (1 << 18) |         \
   (0xf << 20) | (0x3fu << 26))
#define I2C_TIMEOUT_RESERVED 0xffff0000
#define I2C_CLKDIV_RESERVED 0xffff0000
#define I2C_INTSTAT_RESERVED                                                   \
  ((7 << 1) | (1 << 5) | (1 << 7) | (3 << 9) | (7 << 12) | (1 << 18) |         \
   (0xf << 20) | (0x3fu << 26))
...
#define I2C_STAT_MSTCODE_NACKADR                                               \
  (3) /*!< Master NACK by slave on address State Code */
#define I2C_STAT_MSTCODE_NACKDAT                                               \
  (4) /*!< Master NACK by slave on data State Code */
 ...
 */
#define I2C_INTENSET_MSTPENDING                                                \
  (1 << 0) /*!< Master Pending Interrupt Enable Bit */
#define I2C_INTENSET_MSTRARBLOSS                                               \
  (1 << 4) /*!< Master Arbitration Loss Interrupt Enable Bit */
#define I2C_INTENSET_MSTSTSTPERR                                               \
  (1 << 6) /*!< Master Start Stop Error Interrupt Enable Bit */
#define I2C_INTENSET_SLVPENDING                                                \
  (1 << 8) /*!< Slave Pending Interrupt Enable Bit */
#define I2C_INTENSET_SLVNOTSTR                                                 \
  (1 << 11) /*!< Slave not stretching Clock Interrupt Enable Bit */
#define I2C_INTENSET_SLVDESEL                                                  \
  (1 << 15) /*!< Slave Deselect Interrupt Enable Bit */
#define I2C_INTENSET_MONRDY (1 << 16) /*!< Monitor Ready Interrupt Enable Bit  \
                                       */
#define I2C_INTENSET_MONOV                                                     \
  (1 << 17) /*!< Monitor Overflow Interrupt Enable Bit */
#define I2C_INTENSET_MONIDLE (1 << 19) /*!< Monitor Idle Interrupt Enable Bit  \
                                        */
#define I2C_INTENSET_EVENTTIMEOUT                                              \
  (1 << 24) /*!< Event Timeout Interrupt Enable Bit */
#define I2C_INTENSET_SCLTIMEOUT                                                \
  (1 << 25) /*!< SCL Timeout Interrupt Enable Bit */

/*
 * @brief I2C Interrupt Enable Clear register Bit definition
 */
#define I2C_INTENCLR_MSTPENDING                                                \
  (1 << 0) /*!< Master Pending Interrupt Clear Bit */
#define I2C_INTENCLR_MSTRARBLOSS                                               \
  (1 << 4) /*!< Master Arbitration Loss Interrupt Clear Bit */
#define I2C_INTENCLR_MSTSTSTPERR                                               \
  (1 << 6) /*!< Master Start Stop Error Interrupt Clear Bit */
#define I2C_INTENCLR_SLVPENDING                                                \
  (1 << 8) /*!< Slave Pending Interrupt Clear Bit */
#define I2C_INTENCLR_SLVNOTSTR                                                 \
  (1 << 11) /*!< Slave not stretching Clock Interrupt Clear Bit */
#define I2C_INTENCLR_SLVDESEL                                                  \
  (1 << 15)                           /*!< Slave Deselect Interrupt Clear Bit */
#define I2C_INTENCLR_MONRDY (1 << 16) /*!< Monitor Ready Interrupt Clear Bit   \
                                       */
#define I2C_INTENCLR_MONOV                                                     \
  (1 << 17) /*!< Monitor Overflow Interrupt Clear Bit */
#define I2C_INTENCLR_MONIDLE (1 << 19) /*!< Monitor Idle Interrupt Clear Bit   \
                                        */
#define I2C_INTENCLR_EVENTTIMEOUT                                              \
  (1 << 24) /*!< Event Timeout Interrupt Clear Bit */
#define I2C_INTENCLR_SCLTIMEOUT                                                \
  (1 << 25) /*!< SCL Timeout Interrupt Clear Bit */

/*
 * @brief I2C TimeOut Value Macro
 */
#define I2C_TIMEOUT_VAL(n)                                                     \
  (((uint32_t)((n) - 1) & 0xFFF0) |                                            \
   0x000F) /*!< Macro for Timeout value register */

/*
 * @brief I2C Interrupt Status register Bit definition
 */
#define I2C_INTSTAT_MSTPENDING                                                 \
  (1 << 0) /*!< Master Pending Interrupt Status Bit */
#define I2C_INTSTAT_MSTRARBLOSS                                                \
  (1 << 4) /*!< Master Arbitration Loss Interrupt Status Bit */
#define I2C_INTSTAT_MSTSTSTPERR                                                \
  (1 << 6) /*!< Master Start Stop Error Interrupt Status Bit */
#define I2C_INTSTAT_SLVPENDING                                                 \
  (1 << 8) /*!< Slave Pending Interrupt Status Bit */
#define I2C_INTSTAT_SLVNOTSTR                                                  \
  (1 << 11) /*!< Slave not stretching Clock Interrupt Status Bit */
#define I2C_INTSTAT_SLVDESEL                                                   \
  (1 << 15)                          /*!< Slave Deselect Interrupt Status Bit */
#define I2C_INTSTAT_MONRDY (1 << 16) /*!< Monitor Ready Interrupt Status Bit   \
                                      */
#define I2C_INTSTAT_MONOV                                                      \
  (1 << 17) /*!< Monitor Overflow Interrupt Status Bit */
#define I2C_INTSTAT_MONIDLE (1 << 19) /*!< Monitor Idle Interrupt Status Bit   \
                                       */
#define I2C_INTSTAT_EVENTTIMEOUT                                               \
  (1 << 24) /*!< Event Timeout Interrupt Status Bit */
#define I2C_INTSTAT_SCLTIMEOUT                                                 \
  (1 << 25) /*!< SCL Timeout Interrupt Status Bit */
...
#define I2C_SLVQUAL_SLVQUAL0                                                   \
  (0x7F << 1) /*!< Slave Qualifier Address for Address 0 */

/*
 * @brief I2C Monitor Data Register Bit definition
 */
#define I2C_MONRXDAT_DATA                                                      \
  (0xFF << 0) /*!< Monitor Function Receive Data Field */
#define I2C_MONRXDAT_MONSTART (1 << 8) /*!< Monitor Received Start Bit */
#define I2C_MONRXDAT_MONRESTART                                                \
  (1 << 9) /*!< Monitor Received Repeated Start Bit */
#define I2C_MONRXDAT_MONNACK (1 << 10) /*!< Monitor Received Nack Bit */
   ...
   * @param	pI2C	: Pointer to selected I2C peripheral
   * @param	clkdiv	: Clock Divider value for I2C, value is between (1 -
   * 65536)
   * @return	Nothing
   * @note	The clock to I2C block is determined by the following formula
   * (I2C_PCLK is the frequency of the system clock): <br> I2C Clock Frequency =
   * (I2C_PCLK)/clkdiv;
   */
   ...
   * @param	pI2C	: Pointer to selected I2C peripheral
   * @return	All pending interrupts, mask with I2C_INTENSET_* to determine
   * specific interrupts
   */
