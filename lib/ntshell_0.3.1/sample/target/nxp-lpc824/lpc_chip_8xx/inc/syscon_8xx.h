...
#define SYSCTL_WAKEUP_I2C1INT                                                  \
  (1 << 7) /*!< I2C1 interrupt wake-up [Available only on LPC82X] */
#define SYSCTL_WAKEUP_I2C2INT                                                  \
  (1 << 21) /*!< I2C2 interrupt wake-up [Available only on LPC82X] */
#define SYSCTL_WAKEUP_I2C3INT                                                  \
  (1 << 22) /*!< I2C3 interrupt wake-up [Available only on LPC82X] */
...
#define SYSCTL_WAKEUP_I2CINT                                                   \
  SYSCTL_WAKEUP_I2C0INT /*!< Same as #SYSCTL_WAKEUP_I2CINT */
...
#define SYSCTL_SLPWAKE_ADC_PD                                                  \
  (1 << 4) /*!< ADC wake-up configuration [Available only on LPC82x] */
...
#define SYSCTL_NMISRC_ENABLE                                                   \
  ...
  typedef struct
  {
    ...
    __IO uint32_t
        PRESETCTRL; /*!< Offset: 0x004 Peripheral reset control (R/W) */
    __IO uint32_t SYSPLLCTRL; /*!< Offset: 0x008 System PLL control (R/W) */
    __IO uint32_t SYSPLLSTAT; /*!< Offset: 0x00C System PLL status (R/W ) */
    uint32_t RESERVED0[4];
    __IO uint32_t
        SYSOSCCTRL; /*!< Offset: 0x020 System oscillator control (R/W) */
    __IO uint32_t
        WDTOSCCTRL; /*!< Offset: 0x024 Watchdog oscillator control (R/W) */
    __IO uint32_t IRCCTRL; /*!< Offset: 0x028 IRC Control Register (Available
                              only in LPC82X) */
    uint32_t RESERVED1[1];
    __IO uint32_t
        SYSRSTSTAT; /*!< Offset: 0x030 System reset status Register (R/W ) */
    uint32_t RESERVED2[3];
    __IO uint32_t
        SYSPLLCLKSEL; /*!< Offset: 0x040 System PLL clock source select (R/W) */
    __IO uint32_t SYSPLLCLKUEN; /*!< Offset: 0x044 System PLL clock source
                                   update enable (R/W) */
    uint32_t RESERVED3[10];
    __IO uint32_t
        MAINCLKSEL; /*!< Offset: 0x070 Main clock source select (R/W) */
    __IO uint32_t
        MAINCLKUEN; /*!< Offset: 0x074 Main clock source update enable (R/W) */
    __IO uint32_t
        SYSAHBCLKDIV; /*!< Offset: 0x078 System AHB clock divider (R/W) */
    uint32_t RESERVED4[1];
    __IO uint32_t
        SYSAHBCLKCTRL; /*!< Offset: 0x080 System AHB clock control (R/W) */
    uint32_t RESERVED5[4];
    __IO uint32_t UARTCLKDIV; /*!< Offset: 0x094 UART clock divider (R/W) */
    uint32_t RESERVED6[18];
    __IO uint32_t
        CLKOUTSEL; /*!< Offset: 0x0E0 CLKOUT clock source select (R/W) */
    __IO uint32_t
        CLKOUTUEN; /*!< Offset: 0x0E4 CLKOUT clock source update enable (R/W) */
    __IO uint32_t CLKOUTDIV; /*!< Offset: 0x0E8 CLKOUT clock divider (R/W) */
    uint32_t RESERVED7;
    __IO uint32_t
        UARTFRGDIV; /*!< Offset: 0x0F0 UART fractional divider SUB(R/W) */
    __IO uint32_t
        UARTFRGMULT; /*!< Offset: 0x0F4 UART fractional divider ADD(R/W) */
    uint32_t RESERVED8[1];
    __IO uint32_t EXTTRACECMD; /*!< Offset: 0x0FC External trace buffer command
                                  register  */
    __IO uint32_t
        PIOPORCAP0; /*!< Offset: 0x100 POR captured PIO status 0 (R/ ) */
    uint32_t RESERVED9[12];
    __IO uint32_t
        IOCONCLKDIV[7]; /*!< Offset: 0x134 Peripheral clock x to the IOCON block
                           for programmable glitch filter */
    __IO uint32_t BODCTRL; /*!< Offset: 0x150 BOD control (R/W) */
    __IO uint32_t
        SYSTCKCAL; /*!< Offset: 0x154 System tick counter calibration (R/W) */
    uint32_t RESERVED10[6];
    __IO uint32_t IRQLATENCY; /*!< Offset: 0x170 IRQ delay */
    __IO uint32_t NMISRC;     /*!< Offset: 0x174 NMI Source Control     */
    __IO uint32_t
        PINTSEL[8]; /*!< Offset: 0x178 GPIO Pin Interrupt Select register 0 */
    uint32_t RESERVED11[27];
    __IO uint32_t STARTERP0; /*!< Offset: 0x204 Start logic signal enable
                                Register 0 (R/W) */
    uint32_t RESERVED12[3];
    __IO uint32_t STARTERP1; /*!< Offset: 0x214 Start logic signal enable
                                Register 0 (R/W) */
    uint32_t RESERVED13[6];
    __IO uint32_t PDSLEEPCFG; /*!< Offset: 0x230 Power-down states in Deep-sleep
                                 mode (R/W) */
    __IO uint32_t
        PDAWAKECFG; /*!< Offset: 0x234 Power-down states after wake-up (R/W) */
    __IO uint32_t
        PDRUNCFG; /*!< Offset: 0x238 Power-down configuration Register (R/W) */
...
#define SYSCTL_STARTERP1_RESERVED                                              \
...
#define RESET_I2C RESET_I2C0
   ...
   * @return	Nothing
   * @note	The peripheral will stay in reset until reset is de-asserted.
   * Call Chip_SYSCTL_DeassertPeriphReset() to de-assert the reset
   */
  STATIC INLINE void
  Chip_SYSCTL_AssertPeriphReset(CHIP_SYSCTL_PERIPH_RESET_T periph)
  {
   ...
   */
  STATIC INLINE void
  Chip_SYSCTL_DeassertPeriphReset(CHIP_SYSCTL_PERIPH_RESET_T periph)
  {
    LPC_SYSCTL->PRESETCTRL =
        (1 << (uint32_t)periph) |
        (LPC_SYSCTL->PRESETCTRL & ~SYSCTL_PRESETCTRL_RESERVED);
  }
   ...
   * @return	Nothing
   * @note	Brown-out detection reset will be disabled upon exiting this
   * function. Use Chip_SYSCTL_EnableBODReset() to re-enable
   */
  ...
  {
    LPC_SYSCTL->BODCTRL =
        (1 << 4) | (LPC_SYSCTL->BODCTRL & ~SYSCTL_BODCTRL_RESERVED);
  }
   ...
   * @return	Nothing
   * @note	The NMI source will be disabled upon exiting this function. Use
   * the Chip_SYSCTL_EnableNMISource() function to enable the NMI source
   */
  ...
  {
    LPC_SYSCTL->NMISRC =
        SYSCTL_NMISRC_ENABLE | (LPC_SYSCTL->NMISRC & ~SYSCTL_NMISRC_RESERVED);
  }
   ...
   * @return	Nothing
   * @note	For each pin (0-7) that supports an interrupt, the pin number is
   * assigned to that interrupt with this function. Values 0-17 map to pins
   * PIO0-0 to PIO0-17 (For LPC82X Values from 0-28 could be used for PIO0-28).
   */
  ...
  {
    LPC_SYSCTL->STARTERP0 =
        (1 << pin) | (LPC_SYSCTL->STARTERP0 & ~SYSCTL_STARTERP0_RESERVED);
  }
  ...
  {
    LPC_SYSCTL->STARTERP1 =
        periphmask | (LPC_SYSCTL->STARTERP0 & ~SYSCTL_STARTERP0_RESERVED);
  }
   ...
   * @note	A high bit indicates the peripheral will power down on deep
   * sleep.
   */
   ...
   * @param	sleepmask	: OR'ed values of SYSCTL_DEEPSLP_* values (high
   * to powerdown on deepsleep)
   * @return	Nothing
   * @note	This must be setup prior to using deep sleep. See the user
   * manual
   * *(PDSLEEPCFG register) for more info on setting this up. This function
   * selects which peripherals are powered down on deep sleep. This function
   * should only be called once with all options for power-down in that call
   */
  void Chip_SYSCTL_SetDeepSleepPD(uint32_t sleepmask);

  /**
   * @brief	Setup wakeup behaviour from deep sleep
   * @param	wakeupmask	: OR'ed values of SYSCTL_SLPWAKE_* values (high
   * is powered down)
   * @return	Nothing
   * @note	This must be setup prior to using deep sleep. See the user
   * manual
   * *(PDWAKECFG register) for more info on setting this up. This function
   * selects which peripherals are powered up on exit from deep sleep. This
   * function should only be called once with all options for wakeup in that
   * call
   */
