...
typedef enum CHIP_SWM_PIN_FIXED
{
  ...
  {
    LPC_SWM->PINENABLE0 =
        (1 << (uint32_t)pin) | (LPC_SWM->PINENABLE0 & ~SWM_PINENABLE0_RESERVED);
  }

  /**
   * @brief	Tests whether a fixed pin is enabled or disabled in the Switch
   * Matrix
   * @param	pin		: The pin to test whether it is enabled or
   * disabled
